...
class RelatedPromoAdapter(private val context: Context, private val promolist : ArrayList<PromoModel>) : RecyclerView.Adapter<RelatedPromoAdapter.ViewHolder>(){
    val database = FirebaseFirestore.getInstance()
    val TAG = "PreferredAdapter"
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int):
            RelatedPromoAdapter.ViewHolder = ViewHolder(LayoutInflater.from(parent.context).inflate(R.layout.model_similar_promo,parent,false))
