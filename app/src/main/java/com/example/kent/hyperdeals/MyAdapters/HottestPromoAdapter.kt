...
class HottestPromoAdapter(private val context: Context, private val promolist : ArrayList<PromoModel>) : RecyclerView.Adapter<HottestPromoAdapter.ViewHolder>(){
    val database = FirebaseFirestore.getInstance()
    val TAG = "PreferredAdapter"
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int):
            HottestPromoAdapter.ViewHolder = ViewHolder(LayoutInflater.from(parent.context).inflate(R.layout.zzhomelistitem,parent,false))
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        val promos = promolist[position]
            ...
            holder.tv_distance.visibility = View.GONE
            holder.tv_awayy.visibility = View.GONE



        holder.containter.setOnClickListener { showDialog(position) }
    ...
    inner class ViewHolder (view: View): RecyclerView.ViewHolder(view){
        ...
        val tv_awayy = view.tv_away!!
        val containter = view.constraint_holder!!
    }
